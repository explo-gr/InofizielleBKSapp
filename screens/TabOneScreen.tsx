  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.button}>
          ...
          <TouchableOpacity style={styles.box} delayPressIn={0} onPress={() => { Linking.openURL("https://www.gr.ch/DE/institutionen/verwaltung/ekud/ahb/bks/dokumentation/klassen/Documents/Klasse_1UGa.pdf") }}>
...
function getMenuplan() {
  ...
  var url = "https://www.gr.ch/DE/institutionen/verwaltung/ekud/ahb/wvb/Menueplaene/Documents/Menüplan Mensa Münzmühle Woche " + weekNo + ".pdf";
  Linking.openURL(url);
}
